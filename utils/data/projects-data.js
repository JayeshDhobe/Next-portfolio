...
export const projectsData = [
  ...
  {
    id: 5,
    name: "LLmaste – AI-Driven Wellness Companion",
    description:
      "Architected an AI-powered wellness assistant utilizing Retrieval-Augmented Generation (RAG) to deliver personalized mindfulness and wellness advice. Employed LangChain for data chunking and embedding, storing content in a FAISS vector database for efficient semantic search. Integrated Large Language Models (LLMs) using LLM Studio to run the LLaMa model, enabling context-aware conversational responses. Built a scalable backend in Python with Machine Learning algorithms to enhance response accuracy and personalization. Used MongoDB to manage user profiles, preferences, and interaction history, ensuring data persistence and scalability. Designed an intuitive user interface using React for a seamless user experience.",
    tools: ["Python", "React", "MongoDB", "FAISS", "LangChain", "LLM Studio"],
